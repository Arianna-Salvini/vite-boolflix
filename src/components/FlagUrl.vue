...
export default {
    ...
    methods: {
        // Ottenere URL della bandiera dalla lingua
        getFlagUrl(languageType) {
            // Se l'url della bandiera è presente in flagUrls restituisci l'url della bandiera corrispondente
            if (this.flagUrls.hasOwnProperty(languageType)) {
                return this.flagUrls[languageType]
                // console.log(this.flagUrls[languageType])
            } else {
                // Se Url non presente restituisci immagine (locale) mappamondo
